                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8 mb-3 mt-3 mb-sm-0">
                                <span style="color:red;">*</span>Conumable Name</label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8 mb-3 mt-3 mb-sm-0">
                                <span style="color:red;">*</span>Unit Price</label>
                                <input type="text"
                                    class="form-control form-control-user @error('unit_price') is-invalid @enderror"
                                    id="unit_price" placeholder="Unit Price" name="unit_price"
